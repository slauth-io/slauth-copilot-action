...
function downloadSlauth() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield downloadFile(`https://s3.us-east-2.amazonaws.com/${BASE_SLAUTH}-binaries-2/iamcopilot-linux`, copilotName);
...
function runTest(command) {
    return __awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve, reject) => {
            const testProcess = (0, child_process_1.spawn)('bash', [command], {
                shell: true,
                detached: true,
...
function runSlauthStop(slauthToken) {
    return __awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve, reject) => {
            try {
                const name = (0, path_1.join)(__dirname, 'iamcopilot-linux');
                const slauthProcess = (0, child_process_1.spawn)(name, ['stop'], {
                    detached: true,
                    shell: true,
                    env: {
...
function runSlauth(slauthToken, slauthProjectId) {
    return __awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve, reject) => {
            try {
                const name = (0, path_1.join)(__dirname, 'iamcopilot-linux');
                const slauthProcess = (0, child_process_1.spawn)(name, ['start', slauthProjectId], {
                    detached: true,
                    shell: true,
                    env: {
                        IAM_COPILOT_TOKEN: slauthToken
